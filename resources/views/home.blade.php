...
<head>
   ...
   <!-- My Style -->
   <link rel="stylesheet" href="/warunk/css/style.css">
</head>
...
<body>
   ...
   <nav class="navbar">
      ...
      <div class="shopping-cart">
         <div class="cart-item">
            <img src="/warunk/img/products/1.jpg" alt="Product 1">
   ...
   <section id="about" class="about">
      ...
      <div class="row">
         <div class="about-img">
            <img src="/warunk/img/tentang-kami.jpg" alt="Tentang Kami">
         </div>
         <div class="content">
   ...
   <section id="menu" class="menu">
      ...
      <div class="row">
         @foreach ($menus as $menu)
            <div class="menu-card">
               <img src="/warunk/img/menu/1.jpg" alt="Espresso" class="menu-card-img">
